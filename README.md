...
- bomsh_create_bom.py script, which processes the bomsh_hook_raw_logfile generated by bomsh_hook2.py script and creates OmniBOR docs.
...
The bomsh_create_bom.py script takes care of OmniBOR docs creation when reading and processing bomsh_hook_raw_logfile.
